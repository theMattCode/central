...
import { formatJarvisPercent, type JarvisMode, resolveJarvisSystemState } from '@/components/Jarvis/model.ts';
...
import { JarvisOrb } from '@/components/Jarvis/JarvisOrb.tsx';
