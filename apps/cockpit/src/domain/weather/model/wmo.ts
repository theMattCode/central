...
export const WMO_CODE_MAP: Record<number, WMOCodeInfo> = {
  ...
  1: {
    day: mostlyClearDayIcon,
    night: mostlyClearNightIcon,
    i18nKey: I18NKey.WmoMainlyClear,
  },
  2: {
    day: partlyCloudyDayIcon,
    night: partlyCloudyNightIcon,
    i18nKey: I18NKey.WmoPartlyCloudy,
  },
  3: {
    day: overcastDayIcon,
    night: overcastNightIcon,
    i18nKey: I18NKey.WmoOvercast,
  },
  45: { day: fogDayIcon, night: fogNightIcon, i18nKey: I18NKey.WmoFog },
  48: {
    day: overcastDayFogIcon,
    night: overcastNightFogIcon,
    i18nKey: I18NKey.WmoDepositingRimeFog,
  },
  51: {
    day: drizzleIcon,
    night: drizzleIcon,
    i18nKey: I18NKey.WmoLightDrizzle,
  },
  53: {
  ...
  55: {
    day: extremeDayDrizzleIcon,
    night: extremeNightDrizzleIcon,
    i18nKey: I18NKey.WmoDenseDrizzle,
  },
  56: {
  ...
  63: {
    day: overcastDayRainIcon,
    night: overcastNightRainIcon,
    i18nKey: I18NKey.WmoModerateRain,
  },
  65: {
    day: extremeDayRainIcon,
    night: extremeNightRainIcon,
    i18nKey: I18NKey.WmoHeavyRain,
  },
  66: {
    day: overcastDaySleetIcon,
    night: overcastNightSleetIcon,
    i18nKey: I18NKey.WmoLightFreezingRain,
  },
  67: {
    day: extremeDaySleetIcon,
    night: extremeNightSleetIcon,
    i18nKey: I18NKey.WmoHeavyFreezingRain,
  },
  71: { day: snowIcon, night: snowIcon, i18nKey: I18NKey.WmoSlightSnowFall },
  73: {
    day: overcastDaySnowIcon,
    night: overcastNightSnowIcon,
    i18nKey: I18NKey.WmoModerateSnowFall,
  },
  75: {
    day: extremeDaySnowIcon,
    night: extremeNightSnowIcon,
    i18nKey: I18NKey.WmoHeavySnowFall,
  },
  77: { day: hailIcon, night: hailIcon, i18nKey: I18NKey.WmoSnowGrains },
  80: {
    day: partlyCloudyDayRainIcon,
    night: partlyCloudyNightRainIcon,
    i18nKey: I18NKey.WmoSlightRainShowers,
  },
  81: {
    day: overcastDayRainIcon,
    night: overcastNightRainIcon,
    i18nKey: I18NKey.WmoModerateRainShowers,
  },
  82: {
    day: extremeDayRainIcon,
    night: extremeNightRainIcon,
    i18nKey: I18NKey.WmoViolentRainShowers,
  },
  85: {
    day: partlyCloudyDaySnowIcon,
    night: partlyCloudyNightSnowIcon,
    i18nKey: I18NKey.WmoSlightSnowShowers,
  },
  86: {
    day: extremeDaySnowIcon,
    night: extremeNightSnowIcon,
    i18nKey: I18NKey.WmoHeavySnowShowers,
  },
  95: {
